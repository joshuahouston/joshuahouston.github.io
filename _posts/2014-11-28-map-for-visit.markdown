...
I was with them most of the time so the map wasn't really that necessary, but once in a while we'd split up and maybe we used it a couple of times. I can't really remember, but it was fun. I would update the map to show something relevant. For instance, Saturday morning was the Farmer's market and Abby and I went to check that out. So I updated the map to zoom in on that location with a marker.
