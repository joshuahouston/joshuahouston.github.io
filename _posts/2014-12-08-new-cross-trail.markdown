...
---
#Cross Trail Map
There's a new trail going in between Indian River trail and Gavan Hill trail. The old trail cuts through some muskeg and has quite a few rough spots. The new trail continues the wide-lane and fine gravel surface that the cross trail has seen with the recent extensions. I made a little map over the Thanksgiving Holiday to say I was thankful for Sitka's trails. I run on them a lot and almost always am GPS-tracing my running. So I bring all my GPS traces together in QGIS and trace a line, roughly a happy median. Haha, get it? {{ content | emojify }} :wink:
